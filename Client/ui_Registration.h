...
public:
    ...
    void setupUi(QMainWindow *Registration)
    {
        if (Registration->objectName().isEmpty())
            Registration->setObjectName("MainWindow");
        Registration->resize(810, 405);
...
""));
    ...
    {
        Registration->setWindowTitle(QCoreApplication::translate("MainWindow", "Register window", nullptr));
...
namespace Ui {
    class Registration: public Ui_MainWindow {};
} // namespace Ui
